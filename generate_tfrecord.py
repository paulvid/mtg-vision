...
def class_text_to_int(row_label, la):
    #if row_label == FLAGS.label:  # 'ship':
    #    return 1
    # comment upper if statement and uncomment these statements for multiple labelling
     if row_label == FLAGS.label1:
       return 1
     elif row_label == FLAGS.label0:
       return 0
...
def main(_):
    ...
    writer = tf.python_io.TFRecordWriter(args.outputPath)
    path = os.path.join(os.getcwd(), args.imgPath)
    ...
    print('Successfully created the TFRecords: {}'.format(args.outputPath))
